...
/* Lives in its own module so App can build the FAQPage schema from the same
   source without statically importing this lazy-loaded page. */
const FAQS = VAT_REGISTRATION_FAQS
